<?php
    ...
    if(isset($_POST["subFruit"]) && !empty($_POST["subFruit"])){
        ...
        if(isset($_POST["nameFruit1"]) && !empty($_POST["nameFruit1"]) && isset($_POST["cantFruit1"]) && !empty($_POST["cantFruit1"]) && isset($_POST["costFruit1"]) && !empty($_POST["costFruit1"]) && ctype_alpha($name)){
